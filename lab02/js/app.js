...
guessFavoriteNumber();
 ...
 function GussFavoriteFood() {
    var userFavFood = ['mansaf', 'fish', 'white rice', 'chicken', 'pizza', 'burger', 'shawerma', 'maqloba', 'wings'];

    for (var i = 0; i < 6; i++) {
        var userAnsw = prompt('Can you guess my favorite food?');
        var guess = userAnsw.toLowerCase();

        for (var j = 0; j < userFavFood.length; j++){
